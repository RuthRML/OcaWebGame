...
public class Manager {
	...
	public int crearPartida(String nombreJugador, int numeroJugadores) throws Exception {
		Usuario usuario = findUsuario(nombreJugador);		
		Partida partida = new Partida(usuario, numeroJugadores);
	...
	public void addJugador(String nombreJugador) throws Exception {
		if(this.partidasPendientes.isEmpty()) {
			throw new Exception("No hay partidas pendientes. Cree una.");
		}
